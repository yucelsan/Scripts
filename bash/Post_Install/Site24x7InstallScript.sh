...
#livebuild
SERVER='https://ftp.yucelsan.fr/scripts'
...
usage() {
	...
	log $ECHO_PRINT '	Install command   : bash -c "$(curl -sL https://ftp.yucelsan.fr/scripts/Site24x7InstallScript.sh)" readlink [options] -i -key=<device_key>'
	log $ECHO_PRINT ""	
