...
# comma separated
targetedComputerNames = "tanos-rhel7.dc.home.com,patch-opensuse15.dc.home.com"

# Deployment Name variable for inputting into deployment configuration
deployment_name = "API Create Linux One-Time Deployment Test"
...
management_rights_group_name = "All Linux"
...
deployment_configuration = {
        ...
        "targetLimitingGroupIds": targetLimitingGroupIds,
        "startTime": startTime,
        "endTime": endTime,
